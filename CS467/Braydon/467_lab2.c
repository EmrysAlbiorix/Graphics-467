...
double RED[4][4],YELLOW[4][4],EARTH[4][4];
double REDi[4][4],YELLOWi[4][4],EARTHi[4][4];
...
int main() {
	...
	double EARTHobj[4][4],RR[4][4],YY[4][4];
	...
	while (q != 'q') {
		...
		inherent_rgb[1]=0;
		inherent_rgb[2]=0;
		plot(torus_x,torus_y,torus_z,0,2*M_PI,0,2*M_PI,RR);
