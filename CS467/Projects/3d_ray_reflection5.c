...
int test01()
{
  ...
  double lrgb[100][3];
    ...
    irgb[num_objects][0] = 0.6;
    irgb[num_objects][1] = 0.5;
    irgb[num_objects][2] = 0.7; // something
    ...
    reflectivity[num_objects] = 0.2 ;
    irgb[num_objects][0] = 0.9;
    irgb[num_objects][1] = 0.5;
    irgb[num_objects][2] = 0.9; //something
	
    Tn = 0 ;
    Ttypelist[Tn] = SX ; Tvlist[Tn] =   0.2   ; Tn++ ;
    Ttypelist[Tn] = SY ; Tvlist[Tn] =   0.2   ; Tn++ ;
    Ttypelist[Tn] = SZ ; Tvlist[Tn] =   0.5   ; Tn++ ;
    Ttypelist[Tn] = TZ ; Tvlist[Tn] =   6     ; Tn++ ;
    ...
    double width, height;
      ...
      if(id == -1) {printf("failure: can't init map\n");}
      i = get_xwd_map_dimensions(id, dim);
      if(i == -1) {printf("failure: can't dimensions\n");}
